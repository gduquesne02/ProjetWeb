...
if (isset($_POST['name'], $_POST['description'], $_POST['dateEvent'], $_POST['registrationEndDate'], $_POST['location'], $_POST['lattitude'], $_POST['longitude'], $_POST['workshop'], $_POST['goodies'], $_POST['coffeeBreak'], $_POST['lunchBreak'], $_POST['maxMember'], $_POST['hotel_price'], $_POST['hotel_name'], $_POST['hotel_address'])){
